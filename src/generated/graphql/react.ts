...
export type SaveSceneViewMutation = (
  { __typename?: 'Mutation' }
  & Pick<Mutation, 'save'>
);
...
export type SceneViewItemQuery = (
  { __typename?: 'Query' }
  & { sceneViewItem?: Maybe<(
    { __typename?: 'SceneViewItem' }
    & Pick<SceneViewItem, 'id' | 'suppliedId' | 'visible' | 'selected' | 'partRevisionId'>
    & { transform: (
      { __typename?: 'Transform' }
      ...
      { __typename?: 'ColorMaterial' }
      & Pick<ColorMaterial, 'opacity' | 'glossiness' | 'diffuse' | 'ambient' | 'specular' | 'emissive'>
    )> }
  )> }
);
...
export type SceneViewItemFullTransformQuery = (
  { __typename?: 'Query' }
  & { sceneViewItem?: Maybe<(
    { __typename?: 'SceneViewItem' }
    & Pick<SceneViewItem, 'id' | 'suppliedId' | 'visible' | 'worldTransform' | 'partRevisionId'>
    & { transform: (
      { __typename?: 'Transform' }
      & Pick<Transform, 'scale'>
      & { position: (
...
export type PartRevisionQuery = (
  { __typename?: 'Query' }
  & { partRevision?: Maybe<(
    { __typename?: 'PartRevision' }
    & Pick<PartRevision, 'id' | 'partId' | 'suppliedId'>
  )> }
);
...
export type MaterialOverrideSceneViewItemFragment = (
  ...
  & { materialOverride?: Maybe<(
    { __typename?: 'ColorMaterial' }
    & Pick<ColorMaterial, 'opacity' | 'glossiness' | 'ambient' | 'diffuse' | 'emissive' | 'specular'>
  )> }
);
...
export type FullSceneViewItemFragment = (
  { __typename?: 'SceneViewItem' }
  & Pick<SceneViewItem, 'id' | 'visible'>
  & MaterialOverrideSceneViewItemFragment
  & TransformSceneViewItemFragment
);

export type HideSceneViewItemFragment = (
  { __typename?: 'SceneViewItem' }
  & Pick<SceneViewItem, 'visible'>
);
...
export const SaveSceneViewDocument = gql`
    mutation SaveSceneView($enabled: Boolean!, $sceneViewId: ID!, $camera: CameraInput) {
  save(enabled: $enabled, sceneViewId: $sceneViewId, camera: $camera)
}
    `;
export type SaveSceneViewMutationFn = Apollo.MutationFunction<SaveSceneViewMutation, SaveSceneViewMutationVariables>;
 ...
 * });
 */
export function useSaveSceneViewMutation(baseOptions?: Apollo.MutationHookOptions<SaveSceneViewMutation, SaveSceneViewMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SaveSceneViewMutation, SaveSceneViewMutationVariables>(SaveSceneViewDocument, options);
      }
export type SaveSceneViewMutationHookResult = ReturnType<typeof useSaveSceneViewMutation>;
export type SaveSceneViewMutationResult = Apollo.MutationResult<SaveSceneViewMutation>;
export type SaveSceneViewMutationOptions = Apollo.BaseMutationOptions<SaveSceneViewMutation, SaveSceneViewMutationVariables>;
 ...
 * });
 */
export function useSceneViewItemQuery(baseOptions: Apollo.QueryHookOptions<SceneViewItemQuery, SceneViewItemQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SceneViewItemQuery, SceneViewItemQueryVariables>(SceneViewItemDocument, options);
      }
export function useSceneViewItemLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SceneViewItemQuery, SceneViewItemQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SceneViewItemQuery, SceneViewItemQueryVariables>(SceneViewItemDocument, options);
        }
export type SceneViewItemQueryHookResult = ReturnType<typeof useSceneViewItemQuery>;
export type SceneViewItemLazyQueryHookResult = ReturnType<typeof useSceneViewItemLazyQuery>;
export type SceneViewItemQueryResult = Apollo.QueryResult<SceneViewItemQuery, SceneViewItemQueryVariables>;
 ...
 * });
 */
export function useSceneViewItemFullTransformQuery(baseOptions: Apollo.QueryHookOptions<SceneViewItemFullTransformQuery, SceneViewItemFullTransformQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SceneViewItemFullTransformQuery, SceneViewItemFullTransformQueryVariables>(SceneViewItemFullTransformDocument, options);
      }
export function useSceneViewItemFullTransformLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SceneViewItemFullTransformQuery, SceneViewItemFullTransformQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SceneViewItemFullTransformQuery, SceneViewItemFullTransformQueryVariables>(SceneViewItemFullTransformDocument, options);
        }
export type SceneViewItemFullTransformQueryHookResult = ReturnType<typeof useSceneViewItemFullTransformQuery>;
export type SceneViewItemFullTransformLazyQueryHookResult = ReturnType<typeof useSceneViewItemFullTransformLazyQuery>;
export type SceneViewItemFullTransformQueryResult = Apollo.QueryResult<SceneViewItemFullTransformQuery, SceneViewItemFullTransformQueryVariables>;
 ...
 * });
 */
export function usePartRevisionQuery(baseOptions: Apollo.QueryHookOptions<PartRevisionQuery, PartRevisionQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<PartRevisionQuery, PartRevisionQueryVariables>(PartRevisionDocument, options);
      }
export function usePartRevisionLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<PartRevisionQuery, PartRevisionQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<PartRevisionQuery, PartRevisionQueryVariables>(PartRevisionDocument, options);
        }
export type PartRevisionQueryHookResult = ReturnType<typeof usePartRevisionQuery>;
export type PartRevisionLazyQueryHookResult = ReturnType<typeof usePartRevisionLazyQuery>;
export type PartRevisionQueryResult = Apollo.QueryResult<PartRevisionQuery, PartRevisionQueryVariables>;
 ...
 * });
 */
export function usePartQuery(baseOptions: Apollo.QueryHookOptions<PartQuery, PartQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<PartQuery, PartQueryVariables>(PartDocument, options);
      }
export function usePartLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<PartQuery, PartQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<PartQuery, PartQueryVariables>(PartDocument, options);
        }
