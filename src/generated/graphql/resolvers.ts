...
export type ColorMaterialResolvers<
  ContextType = GraphQLContext,
  ParentType extends ResolversParentTypes["ColorMaterial"] = ResolversParentTypes["ColorMaterial"]
> = ResolversObject<{
...
> = ResolversObject<{
  save?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationSaveArgs, "enabled" | "sceneViewId">
  >;
}>;
...
export type PartRevisionResolvers<
  ContextType = GraphQLContext,
  ParentType extends ResolversParentTypes["PartRevision"] = ResolversParentTypes["PartRevision"]
> = ResolversObject<{
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
...
> = ResolversObject<{
  sceneViewItem?: Resolver<
    Maybe<ResolversTypes["SceneViewItem"]>,
    ParentType,
    ContextType,
    RequireFields<QuerySceneViewItemArgs, "sceneViewId" | "itemId">
  >;
  partRevision?: Resolver<
    Maybe<ResolversTypes["PartRevision"]>,
    ParentType,
    ContextType,
    RequireFields<QueryPartRevisionArgs, "revisionId">
  >;
  part?: Resolver<
    Maybe<ResolversTypes["Part"]>,
    ParentType,
    ContextType,
    RequireFields<QueryPartArgs, "partId">
  >;
}>;

export type SceneViewItemResolvers<
  ContextType = GraphQLContext,
  ParentType extends ResolversParentTypes["SceneViewItem"] = ResolversParentTypes["SceneViewItem"]
> = ResolversObject<{
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
  suppliedId?: Resolver<
    Maybe<ResolversTypes["String"]>,
  ...
  materialOverride?: Resolver<
    Maybe<ResolversTypes["ColorMaterial"]>,
    ParentType,
    ContextType
  >;
  worldTransform?: Resolver<
    Maybe<Array<Maybe<ResolversTypes["Float"]>>>,
    ParentType,
    ContextType,
    RequireFields<SceneViewItemWorldTransformArgs, "sceneViewId" | "itemId">
  >;
  partRevisionId?: Resolver<
